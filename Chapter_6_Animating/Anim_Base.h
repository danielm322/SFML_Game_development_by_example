...
#ifndef SFML_GAME_DEVELOPMENT_BY_EXAMPLE_ANIM_BASE_H
#define SFML_GAME_DEVELOPMENT_BY_EXAMPLE_ANIM_BASE_H
#include <string>
...
#endif //SFML_GAME_DEVELOPMENT_BY_EXAMPLE_ANIM_BASE_H
