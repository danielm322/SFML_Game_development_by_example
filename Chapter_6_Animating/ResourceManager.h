...
#ifndef SFML_GAME_DEVELOPMENT_BY_EXAMPLE_RESOURCEMANAGER_H
#define SFML_GAME_DEVELOPMENT_BY_EXAMPLE_RESOURCEMANAGER_H
#include <iostream>
...
#endif //SFML_GAME_DEVELOPMENT_BY_EXAMPLE_RESOURCEMANAGER_H
